...
<head>
  ...
  <title>Login | Admin CMS PT Bukit Asam Tbk</title>
  <link href="<?php echo base_url('/assets/upload/image/ptba.png') ?>" rel="shortcut icon">
...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url() ?>"><b>Login </b>Administrator</a>
        </div>
        <div class="login-box-body">
            ...
            <a href="#" style="margin-left: 100px;">I forgot my password</a><br>
        </div>
    </div>
